...
class NewsSearchDetails extends StatefulWidget {
  const NewsSearchDetails({required this.newsArticle, required this.index, Key? key})
      : super(key: key);
  final List<NewsSearchModel> newsArticle;
  final int index;
  @override
  State<NewsSearchDetails> createState() => _NewsSearchDetailsState();
}

class _NewsSearchDetailsState extends State<NewsSearchDetails> {
  Widget? _icon;
  String domain = ' ';
